<template>
    <div id="drag-tab">
        ...
        >
            ...
            <a-tab-pane v-for="pageItem in tabsList" :key="pageItem.fullPath" :closable="pageItem.name !== 'welcome'">
                <template #tab>
                    <div style="display: inline-block">
                        {{translateMenuTitle(pageItem.name) ? translateMenuTitle(pageItem.name) : pageItem.query ? pageItem.query.name : '' }}
                    </div>
...
<script lang="ts" setup>
    ...
    const setDragFunc=()=>{
        ...
        const dragTab:any= (parentTab.querySelector('.ant-tabs-nav-wrap') as HTMLElement).firstChild
        if (dragTab){
